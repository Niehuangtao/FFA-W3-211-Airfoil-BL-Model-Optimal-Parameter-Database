function compare_optimal_result_MSE(para_local,para_init,setcase) 
    ...
    exp_data  = [a0,cl];
    MSE_data  = [rad2deg(a(idx_s:idx_l))',CN_total(idx_s:idx_l)];

    save(fullfile(outputDir, ['data_collection_' objectiveName '.mat']), 'init_data', 'exp_data', 'MSE_data');
end